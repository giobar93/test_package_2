...
var InnerAppBarStyle = { zIndex: -2, flexGrow: 1, color:"#133c70",display: "flex", justifyContent: "center", alignItems: "center", position: "absolute", right: 0, left: 0 }
...
export var drawerStyle = {
    ...
    width: '0',
    flexShrink: 0,
    [`& .MuiDrawer-paper`]: { position:"relative",width: '320px', boxSizing: 'border-box', backgroundColor:"#e4f0ff00",borderRight:'2px solid #133c70'},
}
      ...
      <Toolbar sx={toolbarStyle}>
        ...
        <Stack direction={"column"} sx={InnerAppBarStyle}>
          ...
          {subtitle && (
            <Typography
              component="div"
              sx={{ fontSize: 14, flexGrow: 1, textAlign: "center"}}
            >
              {subtitle}
            </Typography>
          )}
